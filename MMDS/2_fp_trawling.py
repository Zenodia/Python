...
def label(data):
    ...
    # flatten the basket items to create a unique set of items
    for i in range(0, l):
...
print "frequent item pairs: look at the items on the right not the basket# "
